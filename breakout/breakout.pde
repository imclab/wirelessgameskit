/*/---------------
 ...
 Modified for use in Digi's Wireless Games Kit. This game uses Digi's XBee Game
 Controller library to handle user input by replacing the control handling
 through setting the variables and calling the methods originally done through
 mouse and keyboard input. See the buttonEvent method below, and the beginning
 of the draw method, for more details.
 ---------------/*/
